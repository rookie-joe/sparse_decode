...
if __name__ == "__main__":
    ...
    model_name_or_path = "/DATA/disk2/lujianqiao/models/Qwen2.5-0.5B-Instruct/"
    ...
    # replace flash attention with quest attention
    patch_model(
        llm,
        max_new_tokens=1024,
    ...
    print("\n\n")
    print("INPUT TOKENS:", result["input_len"])
    print("OUTPUT TOKENS:", result["output_len"])
    print("TOKENS/SECOND:", result["output_len"] / (end_time - start_time))
